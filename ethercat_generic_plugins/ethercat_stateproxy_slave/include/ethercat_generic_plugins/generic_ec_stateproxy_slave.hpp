...
#ifndef ETHERCAT_GENERIC_PLUGINS__GENERIC_EC_STATEPROXY_SLAVE_HPP_
#define ETHERCAT_GENERIC_PLUGINS__GENERIC_EC_STATEPROXY_SLAVE_HPP_
...
namespace ethercat_generic_plugins
{
  ...
  class EcStateProxySlave : public GenericEcSlave
  {
  public:
    EcStateProxySlave();
    virtual ~EcStateProxySlave();
...
#endif // ETHERCAT_GENERIC_PLUGINS__GENERIC_EC_STATEPROXY_SLAVE_HPP_
